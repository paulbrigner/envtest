  ...
  return (
    <main style={{ fontFamily: "system-ui, sans-serif", padding: 24 }}>
          ...
          {JSON.stringify(
            {
              NEXT_PUBLIC_PUBLIC_KEY:
                process.env.NEXT_PUBLIC_PUBLIC_KEY || null,
      ...
      <section style={{ marginTop: 24 }}>
        ...
        <pre style={{ background: "#f6f8fa", padding: 12 }}>
          {JSON.stringify(
            {
              ...serverVars,
              SERVER_SECRET_MASKED: serverVars.SERVER_SECRET ? "SET" : null,
            },
            null,
            2
          )}
      ...
      <p style={{ color: "#555" }}>
        ...
        <br />- Client (build-time): <code>NEXT_PUBLIC_*</code>
        <br />- Server (runtime): any name, available via{" "}
